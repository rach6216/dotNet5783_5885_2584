...
public class User:IUser
{
    ...
    public void AddItemToCart(int userID, string pass, OrderItem oi)
    {
       ...
       //user.CartItems = ordersItems.Select(oi => new DO.OrderItem() { Amount = oi.Amount, ID = oi.ID, Price = oi.Price, ProductID = oi.ProductID }).ToList<DO.OrderItem?>();
